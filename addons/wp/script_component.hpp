...
#define TASK_ATTACK_SIZE 50

#define TASK_DEFEND_SIZE 75
#define TASK_DEFEND_TELEPORT false
#define TASK_DEFEND_USECOVER 0
#define TASK_DEFEND_STEALTH false
#define TASK_DEFEND_PATROL false
